        ...
        <div className="p-6 sm:p-10 lg:p-12 overflow-y-auto max-h-screen bg-white dark:bg-gray-900">
          ...
          <form onSubmit={handleEmailSubmit} className="space-y-4">
            ...
            <div>
              ...
              {mode === 'register' && (
                <p className="text-[11px] text-stone-400 dark:text-gray-500 mt-1.5">Must be at least 8 characters long</p>
              )}
            </div>
          ...
          {/* Google Login disabled until backend OAuth is added */}
          <button disabled
            className="w-full py-3.5 border-2 border-stone-200 dark:border-gray-700 rounded-xl text-sm font-semibold text-stone-500 dark:text-gray-500 flex items-center justify-center gap-2.5 bg-stone-50 dark:bg-gray-800 cursor-not-allowed opacity-70">
          ...
          {/* Demo hint removed - API auth only */}
        </div>
      </div>
    </div>
  );
